...
def get_local_today():
    # Adjust server time back to North American standard zones to prevent premature calendar flipping
...
# Changed to 2 columns to cleanly present Today vs Tomorrow
...
if player_count == 0:
    ...
    for idx, (_, p_row) in enumerate(unique_players.iterrows()):
        ...
        for stat in stats_to_analyze:
            ...
            # VEGAS-STYLE RECENCY-WEIGHTED BASELINE BLENDING (60/40)
